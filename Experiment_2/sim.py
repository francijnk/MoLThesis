        ...
        if turnover_rounds > 0:
            for _ in range(replace):    
                ...
                for _ in range(turnover_rounds):
                    ...
                    new_agent.prior = smooth_posterior(new_agent.prior, compress_prior, alpha=alpha)
...
def main():
    ...
    priors = [log_non_normed_prior(g, 1.0) for g in gr_strings]
    ...
    results_dir = f"results_snellius/{args.mode}/{args.replace}/{name}"
