...
def main():
    ...
    parser.add_argument("--init_rounds", type=int, required=True)
    ...
    result, data = simulation(
        ...
        edge_remove, args.init_rounds
    )

    results_dir = f"results_snellius/{args.mode}/{args.replace}/{args.init_rounds}"
